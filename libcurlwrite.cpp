                            ...
                            const char *localpath)
{
  ...
  if(-1 == remoteFileSizeByte) {
    printf("Error reading the remote file size!\n");
    //return -1;
  }
...
int main(void)
{
  const char *remote = "sftp://u38989:amitin9sti@u38989.ssh.masterhost.ru/home/u38989/upload.dat";
  const char *filename = "upload.dat";
